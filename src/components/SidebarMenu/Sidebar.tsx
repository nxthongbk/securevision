...
const navItems = [
  {
    label: 'Cameras',
    icon: <VideoCamera size={20} className="" />,
    to: '/cameras',
  },
  { label: 'Birdseye', icon: <Eye size={20} />, to: '/birdseye' },
  { label: 'Events', icon: <CalendarDots size={20} />, to: '/events' },
  { label: 'Exports', icon: <Download size={20} />, to: '/exports' },
  { label: 'Storage', icon: <Database size={20} />, to: '/storage' },
  { label: 'System', icon: <HardDrives size={20} />, to: '/system' },
  { label: 'Config', icon: <GearSix size={20} />, to: '/config' },
  { label: 'Logs', icon: <ClipboardText size={20} />, to: '/logs' },
];
