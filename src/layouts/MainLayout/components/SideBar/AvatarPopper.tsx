...
// function AvatarPopper({ pagelabels }: { pagelabels?: string }) {
...
//   return (
//     <>
//       <div className='justify-center hidden mt-6 mb-4 miniLaptop:flex miniLaptop:w-full'>
//         <Avatar
...
//               <Typography variant='label3'>{userInfo?.name || userInfo?.username}</Typography>
//               <Typography variant='caption'>{userInfo?.roles?.[0] || ''}</Typography>
//             </div>
//           </MenuItem>
//           {sidebarOptions.map((option) => (
//             <MenuItem
//               onClick={() => {
//                 navigate(tenantCode ? `${option.path}?tenantCode=${tenantCode}` : option.path);
//                 handleClose();
//               }}
//               key={option.labels}
//               disableRipple
//               className={classNames('w-full h-10 !rounded-md', {
//                 '!bg-[var(--primary)] !text-[white]': option.path === location.pathname
//               })}
//             >
//               {option.icon}
//               <Typography variant='body3'>{option.labels}</Typography>
//             </MenuItem>
//           ))}
//         </div>
//       </StyledMenuSiderbar>
//       <Typography variant='label2' className='flex miniLaptop:hidden'>{pagelabels}</Typography>
//     </>
//   );
// }
